<svg class="logo w-18 lg:w-24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 306 185">
	<title>lab</title>
	<rect
		class="logo__l fill-b stroke-b dark:fill-w dark:stroke-w"
		x="0.5"
		y="2.5"
		width="27"
		height="178" />
	<path
		class="logo__a-1 fill-b dark:fill-w"
	...
	<path
		...
		transform="translate(-709 -330)" />
	<path
		class="logo__liquid-1 fill-lp dark:fill-dp"
		...
		transform="translate(-709 -330)" />
	<path
		class="logo__liquid-2 fill-transparent stroke-b dark:stroke-w"
		d="M982.5,456c-1.38-3.48-6.17-5.48-10-5.53-8.17-.11-10.39,8.68-19,12-13.7,5.28-27.76-9.42-30.26-6.47-2.85,3.37,9.71,29.37,29.63,29.47C970.89,485.59,985.83,464.43,982.5,456Z"
		transform="translate(-709 -330)" />
	<path
		class="logo__b-1 fill-b dark:fill-w"
	...
	<path
		...
		transform="translate(-709 -330)" />
	<circle
		class="logo__liquid-bubble fill-lp stroke-lp dark:fill-dp dark:stroke-dp"
		cx="250.5"
		cy="42.5"
		r="8" />
	<circle
